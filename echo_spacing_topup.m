...
matrixsize_phase_enc_dir    = 128; % matrix size in y direction (if that is phase encoding direction)
epifactor 					= 45; % EPI factor
water_fat_shift_pixel 		= 11.905; % water-fat shift per pixel
